...
The <a href= "src/startup/main.cpp">file</a> in which this is implemented is a C++ file written primarily in C. The repo is cloned from UBC Orbit to work with the STM-32 Microcontroller in preparation for future work on Aleasat OnBoard Computer (OBC). 
